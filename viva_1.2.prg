...
? "*****************************************************************************************"
? "* viva.exe versao 1.2 - 17/06/2025 - Regional de saude entorno sul                      *"
...
do while .not. eof()
replace tp_not with "x" for ( (def_fisica = "2" .or. (empty(def_fisica) = .T. )) .and. (def_mental = "2" .or. (empty(def_mental) = .T. )) .and. (def_visual = "2" .or. (empty(def_visual) = .T. )) .and. (def_auditi = "2" .or. (empty(def_auditi) = .T. )) .and. (tran_ment = "2" .or. (empty(tran_ment) = .T. )) )
skip
enddo
